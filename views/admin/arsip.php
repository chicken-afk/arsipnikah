  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
            <a href="arsip.php" class="nav-link active ">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Upload Arsip N1-N6</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
   ...
   <section class="content">
     ...
     <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Upload Foto N1-N6 yang sudah ditandatangani</h3>
            <?php 
                        if(isset($_GET['pesan'])){
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="../../controller/inputBerkas.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label>Nomor KTP Pria</label>
                      <input type="text" class="form-control" name="ktpPria" placeholder="Masukan Nomor KTP Pria" required="required">
                    </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="form-group">
                <label>N1</label>
                 <input type="file" class="form" name="n1" required="required">
              </div>
              
              <div class="form-group">
                <label>N2</label>
                 <input type="file" class="form" name="n2" required="required">
              </div>
              
              <div class="form-group">
                <label>N3</label>
                 <input type="file" class="form" name="n3" required="required">
              </div>
              ...
              <div class="form-group">
                <label>N4</label>
                 <input type="file" class="form-contrrol" name="n4" required="required">
                
              </div>

              <div class="form-group">
                <label>N5</label>
                 <input type="file" class="form" name="n5" required="required">
                
              </div>

              <div class="form-group">
                <label>N6</label>
                 <input type="file" class="form" name="n6" required="required">
