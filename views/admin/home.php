...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <figure class="figure">
        <img src="../../assets/gambar/profil2.png" class="figure-img  mx-auto d-block" alt="A generic square placeholder image with rounded corners in a figure.">
        <figcaption class="figure-caption">
        <h1>
          Sistem Informasi Arsip Surat
        </h1>
        <h5>
          Kantor Urusan Agama Kecamatan Tombolo Pao, Goa, Sulawesi Selatan
        </h5>
        <p>
          Jl. Kr. Pado No. 03 Tombolo Kel. Tamaona Kec. Tombolo Pao Kab. Gowa
        </p>
      </figcaption>
    </figure>   
</center>
