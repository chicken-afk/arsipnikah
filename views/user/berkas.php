  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Berkas Persyaratan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
     ...
     <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Upload Foto Berkas Persyaratan</h3>
            <?php 
                        if(isset($_GET['pesan'])){
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="../../controller/user/inputBerkas.php" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group">
                <label>N4</label>
                 <input type="file" class="form" name="n4" required="required">
